...
**Currently learning:** TypeScript, CI/CD workflows, software testing, computer systems security (vulnerabilities, threats and protecion measures), advanced software quality measures and strategies (metrics, standards, management and implementation), advanced databases (NoSQL databases, parallel databases, multidimensional databases and more).
