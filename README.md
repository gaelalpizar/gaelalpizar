...
<table>
  <tr>
    <td>
      <img src="https://github.com/user-attachments/assets/aab70a2f-ddea-4658-9e16-8cc0258f0946" width="250"/>
    </td>
    <td>
      Hello! I'm Gael, a passionate last year software engineering Costa Rican student at the University of Costa Rica, 
      focused on full-stack web development and modern software engineering practices.
    </td>
  </tr>
</table>
...
- 💡 I love building systems that are not only functional, but also **scalable**, **secure**, and **maintainable**.
- 🧠 Always exploring software engineering concepts such as design patterns, distributed systems, software architecture, and frameworks that power real-world applications.
...
- **Other:** Git, GitHub, Linux, Docker (beginner), CMake, Make, R, RStudio, Visual Studio Code, Visual Studio
